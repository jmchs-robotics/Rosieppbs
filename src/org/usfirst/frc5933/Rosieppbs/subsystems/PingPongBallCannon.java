...
public class PingPongBallCannon extends Subsystem {
	...
	public void pistonStart() {
		...
		RobotMap.ballHopperBallReleasePlunger.set(-.5 * 12.6 / current); //in theory this should standardize the speed over all voltages ...
		RobotMap.ballHopperBallReleasePlunger.set(-.5 * initBatteryVoltage / voltage); //in theory this should standardize the speed over all currents...
	}
