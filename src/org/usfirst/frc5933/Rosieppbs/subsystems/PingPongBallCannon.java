...
public class PingPongBallCannon extends Subsystem {
    ...
    private final PowerDistributionPanel powerDistributionPanel1 = RobotMap.pingPongBallCannonPowerDistributionPanel1;
	...
	public void pistonStart() {
		ballReleasePiston.set(-.5 * initBatteryVoltage / voltage); //in theory this should standardize the speed over all currents...
	}
