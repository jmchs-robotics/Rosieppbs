...
public class OI {
    ...
    public OI() {
        ...
        xButton.whenPressed(new ReleaseHighSpeed());


        // SmartDashboard Buttons
        SmartDashboard.putData("DefaultAutonomousCommand", new DefaultAutonomousCommand());
        SmartDashboard.putData("LIDAR", new LIDAR());
        SmartDashboard.putData("NullCommand", new NullCommand());
        SmartDashboard.putData("ReleaseBall", new ReleaseBall());
        SmartDashboard.putData("ReleaseHighSpeed", new ReleaseHighSpeed());
        SmartDashboard.putData("ReleaseMediumSpeed", new ReleaseMediumSpeed());
        SmartDashboard.putData("ReleaseLowSpeed", new ReleaseLowSpeed());
