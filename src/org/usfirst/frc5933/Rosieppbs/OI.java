...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveStraightTime", new DriveStraightTime());
        SmartDashboard.putData("AlignWithTarget", new AlignWithTarget());
        SmartDashboard.putData("DeliverCenterGear", new DeliverCenterGear());
        SmartDashboard.putData("DriveStraightLidar", new DriveStraightLidar());
        SmartDashboard.putData("DriveStraightVision", new DriveStraightVision());
