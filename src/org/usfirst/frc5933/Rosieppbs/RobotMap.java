...
public class RobotMap {
	...
	public static void init() {
		...
		driveTrainRobotDrive = new RobotDrive(driveTrainFrontLeft, driveTrainRearLeft, driveTrainFrontRight,
				driveTrainRearRight);
	...
	public static void disabledInit() {
		...
		/*
		 * if(helmsman_ != null){ try{ helmsman_.stoprunning(); helmsman_.join();
		 * helmsman_ = null; } catch(Exception e){ e.printStackTrace(); } }
		 */
	}
}
