...
public class DriveStraight extends Command {
	...
	protected void initialize() {
		setTimeout(10); // start against the wall, set speed/time,
	...
	protected boolean isFinished() {
		return isTimedOut(); // end at an angle, slightly drifted/angled to the right
	}

	// Called once after isFinished returns true
	protected void end() {
		RobotMap.driveTrainRobotDrive.tankDrive(0, 0); // stop everything
	}
