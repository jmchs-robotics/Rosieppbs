...
public class StartMediumFlyWheel extends Command {
    private static final double kMediumFlyWheeelSpeed = -0.50;
    private static final double kDistanceToCan = 138; // FIXME
	...
	protected void initialize() {
        ...
        double value = kMediumFlyWheeelSpeed * Electrical.kFullyChargedBatteryVoltage / RobotMap.electricalPowerDistributionPanel.getVoltage();
