...
public class StartFastFlyWheel extends Command {
    ...
    protected void initialize() {
        ...
        double value = BallLauncher.kFastFlyWheeelSpeed * Electrical.kFullyChargedBatteryVoltage / RobotMap.electricalPowerDistributionPanel.getVoltage();
        Robot.ballLauncher.set(value, FieldElements.kFarCanLidarFrontDistance);
    }
