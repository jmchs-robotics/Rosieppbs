...
public class AimLauncher extends Command {
	...
	public void take_directions_from_helmsman() {
		...
		/*
		 * switch (direction) { case Helmsman.NADA: if (Robot.debugModeEnabled)
		 * System.out.println("Skipping along..."); Robot.driveTrain.turn_left(0);
		 * return; case Helmsman.LEFT: if (Robot.debugModeEnabled)
		 * System.out.println("LEFTING"); Robot.driveTrain.turn_left(0.3); return; case
		 * Helmsman.RIGHT: if (Robot.debugModeEnabled) System.out.println("RIGHTING");
		 * Robot.driveTrain.turn_right(0.3); return; }
		 */
